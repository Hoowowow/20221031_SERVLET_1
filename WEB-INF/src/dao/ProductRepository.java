...
// ArrayList를 Product로 캐스팅
	...
	public ProductRepository() {
		Product phone = new Product("P1234", "인형 키링", 8000); //상품코드, 상품이름, 가격
		phone.setDescription("사이즈 : 6*8, 8*10, 10*12" + "<br>" + "컬러 : 화이트, 베이지, 블랙, 그레이");
		phone.setCategory("keyring");
		...
		Product notebook = new Product("P1235", "아크릴 키링", 15000); 
		notebook.setDescription("사이즈 : 5*5, 6*6" + "<br>" + "컬러 : 핑크, 블루, 퍼플");
		notebook.setCategory("keyring");
		...
		Product tablet = new Product("P1236", "비즈 키링", 9000);
		tablet.setDescription("컬러 : 블랙, 실버, 핑크, 블루, 옐로우, 그린, 퍼플");
		tablet.setCategory("keyring");
