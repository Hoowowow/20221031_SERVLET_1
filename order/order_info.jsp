...
<body>
	...
	<div class="col-sm-3">
		<input name="shippingDate" type="date" id ="Date" class="form-control" required >
	</div>
	  </div>
    <div class="form-group row">
	...
	<div class="form-group row">
	   <div class="col-sm-offset-2 col-sm-10 ">
        ...
        <script>
            ...
            // 현재 로컬 시간과 UTC 사이의 차이를 계산합니다.
            var timeOff = new Date().getTimezoneOffset()*60000;
            // 로컬 시간에서 UTC와의 차이를 빼고, ISO 형식으로 변환하여 날짜를 가져옵니다.
            var today = new Date(now_utc-timeOff).toISOString().split("T")[0];
            // id가 "Date"인 요소의 min 속성 값을 오늘 날짜로 설정합니다.
